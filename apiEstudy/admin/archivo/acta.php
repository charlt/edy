...
$carpeta = htmlspecialchars($id_alumno);
$ruta = htmlspecialchars('../../../assets/archivos_alumno/');
...
$target_file = $target_dir ."/acta.".$imageFileType;
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        $res = substr($target_file,);
        $json = array("status" => 1, "msg" => "El acta se guardó correctamente.");
