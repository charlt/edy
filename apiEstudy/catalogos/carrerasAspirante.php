...
try {
  if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    $query_carreras = query('SELECT cc.carrera_id,cc.institucion_id, cc.nivel_estudios_id, 
    cc.carrera_clave, cc.carrera, cc.imagen_url, cc.objetivo,
    cne.nivel_estudios_id, cne.nivel_estudios_clave, cne.nivel_estudios
     FROM tr_carrera cc
    join cat_nivel_estudios cne on cc.nivel_estudios_id = cne.nivel_estudios_id where cc.estatus = 1');
