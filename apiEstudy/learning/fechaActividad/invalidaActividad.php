  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
    foreach($_POST as $clave => $valor){
      ...
      $usuario = Auth::GetData(
        ...
        ''.$materia_fecha_actividad_id.', '.$persona_id.',"'.$texto.'",'.$usuario->id_rol.',now(), 1');

        update('tr_materia_fecha_actividad','estatus_actividad_id = 6 ','materia_fecha_actividad_id = '.$materia_fecha_actividad_id);
