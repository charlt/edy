...
try {
  ...
  if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    $query = query('
    select tv.videoconferencia_id,tv.url_meet,tv.nombre,tg.grupo,tg.nombre_grupo,UNIX_TIMESTAMP(tv.fecha_inicio)  as fecha_inicio,UNIX_TIMESTAMP(tv.fecha_fin) as fecha_fin,
        ...
        where now() < tv.fecha_fin and tv.estatus = 1 and tm.estatus = 1 and alumno_id = '.$usuario->id.'
