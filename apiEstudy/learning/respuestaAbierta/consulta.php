...
try {
  ...
  if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    $query_respuesta = query('SELECT *
     FROM tr_pa_respuesta WHERE pregunta_id = '.$id_pregunta.' and materia_fecha_actividad_id = '.$id_materia_fecha_actividad);
       ...
       if(num($query_respuesta)){
    		$json = array("status" => 1, "msg" => "Se encontró la respuesta","respuesta" => $json_respuesta);
    	 }else{
