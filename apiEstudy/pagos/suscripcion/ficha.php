...
join inter_pago_carrera ipc on ipc.pago_carrera_id = tsp.pago_carrera_id
join '.$GLOBALS['db_datosGenerales'].'.personas p on p.persona_id = tsp.persona_id
join '.$GLOBALS['db_datosGenerales'].'.tr_carrera tc on tc.carrera_id = ipc.carrera_id
...
where p.persona_id = '.$id_alumno.' and tsp.estatus_pago_id = 1 and estatus_solicitud_pago_id in (1,2)'));
