...
try {
  ...
  foreach($_GET as $clave => $valor){
    ${$clave} = escape_cara($valor);
      ...
      $query=query('SELECT tt.descripcion_ticket,p.nombre,p.primer_apellido, p.segundo_apellido,p.email, tc.carrera, coj.orden_jerarquico_descripcion,csa.situacion_alumno_descripcion 
      ...
      ipo.estatus= 1 and tpe.estatus=1 and tc.estatus= 1');
