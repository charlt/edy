...
try {
  ...
  foreach($_GET as $clave => $valor){
    ${$clave} = escape_cara($valor);
      ...
      where ipo.plan_estudio_id = '.$arreglo_plan['plan_estudio_id'].' and ioa.estatus = 1 and  ca.estatus=1 and tg.estatus=1 and ipo.estatus=1
      ');
  ...
  $objPHPExcel->getActiveSheet()->getStyle('A4:P4')->applyFromArray($estiloTituloColumnas);
   ...
   $fila=5;
	...
	$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A5:P".$fila);
