...
try {
  ...
  if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $query = query('select tm.materia_id,ta.clave_alumno,p.nombre,p.primer_apellido,p.segundo_apellido,p.email ,ca.asignatura_clave,ca.asignatura_id,ca.asignatura,tm.calificacion 
      from tr_materia tm
