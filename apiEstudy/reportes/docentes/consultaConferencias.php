...
try {
  ...
  foreach($_GET as $clave => $valor){
    ${$clave} = escape_cara($valor);
      ...
      $arreglo_plan = arreglo(query('select plan_estudio_id, plan_estudio from '.$GLOBALS['db_datosGenerales'].'.tr_plan_estudios where plan_estudio_id = '.$id_plan_estudios.' and estatus = 1'));
