...
$arreglo_cabecera = arreglo(query('select tpe.rvoe, iag.asignatura_grupo_id, cc.ciclo_desc,
        coj.orden_jerarquico_descripcion, tg.nombre_grupo, 
...
$pdf->SetXY(90, 13);
$pdf->Cell(70, 10, 'UNIVERSIDAD CONTINENTAL', 0, 1, 'C', 0);
$pdf->SetXY(90, 22);
...
$query_alumnos = query('select tm.alumno_id, p.nombre, p.primer_apellido, p.segundo_apellido,
    ...
    and tm.estatus=1 and imag.estatus=1 and ta.estatus=1 and tmfa.estatus=1 order by p.primer_apellido, p.segundo_apellido, p.nombre');
