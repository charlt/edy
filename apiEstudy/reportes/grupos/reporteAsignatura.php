...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        $query_grupo = query(" select tg.grupo_id , ca.asignatura,tm.alumno_id,p.nombre, p.primer_apellido, p.segundo_apellido,
         tm.asignatura_grupo_id, tm.calificacion, ta.clave_alumno, ca.asignatura_clave, tg.nombre_grupo
        from tr_grupo tg 
        ...
        where tg.estatus= 1 and iag.estatus=1 and ialg.estatus=1 and tm.estatus=1 and ioa.estatus=1 and ioa.estatus=1 and tg.grupo_id=".$id_grupo."
