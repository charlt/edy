...
try {
  if($_SERVER['REQUEST_METHOD'] == "GET"){
    foreach($_GET as $clave => $valor){
      ...
      $json_encuesta=$encuesta::consulta($id_encuesta);

      if(isset($json_encuesta['encuesta_id'])){
          $json_campo_encuesta=$encuesta::consulta_campo_encuesta($json_encuesta['encuesta_id'],$id_switch_encuesta,$id_persona);
