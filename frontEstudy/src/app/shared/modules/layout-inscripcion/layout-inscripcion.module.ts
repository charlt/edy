...
import { HeaderComponent } from '../../../inscripcion/components/header/header.component';
import { SidebarComponent } from '../../../inscripcion/components/sidebar/sidebar.component';
...
export class LayoutInscripcionModule { }
